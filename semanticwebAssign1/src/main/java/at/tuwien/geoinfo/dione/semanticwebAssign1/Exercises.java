...
public class Exercises {
	...
	public static void main(String[] args) 
	{
		...
		//use matrikel# as UID,
		GroupMember marvin = new GroupMember(model, NS,NSPrefix,"0830619","Marvin", "Mc Cutchan", "marvin.mccutchan@geo.tuwien.ac.at", "GIS" ,"Royal Institute of Technology (KTH), Stockholm", "10-88","https://www.geo.tuwien.ac.at/staff/marvin-mc-cutchan/",13);
		try 
		{
